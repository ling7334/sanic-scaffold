...
Thank you for investing your time in contributing to our project! Any contribution you make will be appreciate :sparkles:. 
...
3. Install or update to **Python 3.10.5**. For more information, see [the development guide](contributing/development.md).
